<template>
    <BSlideover v-model="isOpen">
        ...
        <template #default>
            <form @submit.prevent="submit" id="create-recipient-form" class="flex flex-1 flex-col justify-between" :action="request.url()" :method="request.method()">
